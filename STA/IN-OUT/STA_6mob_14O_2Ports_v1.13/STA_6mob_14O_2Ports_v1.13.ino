...
byte in_pin[ OUT_PINS_NUMBER ] = { 0 , 5 , 6 , 7 }; //order is in coherence with the out pins array(s).
...
*/
const int OUT_PINS_NUMBER = 6;
//byte in_pin[OUT_PINS_NUMBER] = { 0 , 5 , 6 }; 
byte in_pin[1] = { '0' }; //dummy value, since we don't want any input taken from a pin of the NodeMCU.
char out_pin_symbol[OUT_PINS_NUMBER] = {'0', '3' , '4' , '5', '6', '7'}; //for the sake of debugging using the serial monitor you must free '9' and 'a'
