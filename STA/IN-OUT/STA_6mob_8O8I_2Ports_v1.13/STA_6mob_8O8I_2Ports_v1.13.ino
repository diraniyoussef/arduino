...
byte in_pin_PCF1[ in_pins_number_PCF1 ] = {0, 1, 2, 3}; //the order between the two arrays in_pin_PCF1 and out_pin_PCF1 matters.
const byte out_pins_number_PCF1 = 4;
byte out_pin_PCF1[ out_pins_number_PCF1 ] = {4, 5, 6, 7}; 
char out_pin_symbol_PCF1[ out_pins_number_PCF1 ] = {'b', 'c', 'd', 'e'}; //the order between the two arrays out_pin_PCF1 and out_pin_symbol_PCF1 matters.
//************************************************End of block.
