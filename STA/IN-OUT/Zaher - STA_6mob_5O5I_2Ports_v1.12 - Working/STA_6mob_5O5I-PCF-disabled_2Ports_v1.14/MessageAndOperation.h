...
private: 
  const String module_Id_Str = "Youssef_70853721:panel_of_Zaher:"; //this is very unintuitive to be correct (since in the sketch its definition is placed after the include to this header file) but luckily it is.
  ...
  const String mob_Id_Str[mob_Number] = { "mob_S4", "mob2"}; 
