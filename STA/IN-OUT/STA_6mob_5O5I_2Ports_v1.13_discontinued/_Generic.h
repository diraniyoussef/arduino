...
const int SERVERS_NUMBER_TO_MAINTAIN_CONNECTION = 2;
const int MAX_SERVED_CLIENTS = 6;
...
class General{
  ...
  static int getOtherIndex(int k) {
    if (k == 0) {
      k = 1;
    } else  {
      k = 0;
...
public:
  ...
  static void wifiSetup(){
    ...
    server[0].setNoDelay(true);//I think everything you send is directly sent without the need to wait for the buffer to be full
