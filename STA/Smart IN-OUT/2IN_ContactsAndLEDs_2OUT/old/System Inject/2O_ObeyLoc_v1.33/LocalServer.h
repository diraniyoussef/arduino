...
private:   
  ...
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { "10:\0", "S4:\0", "TrekStor_Tab:\0", "S7_Edge:\0"  }; //e.g.(reflected_id_buff + 2)[4] will the 'M' ???  Local_Server_Number  
  ...
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { "8:\0"  }; //e.g.(reflected_id_buff + 2)[4] will the 'M' ???  Local_Server_Number  
