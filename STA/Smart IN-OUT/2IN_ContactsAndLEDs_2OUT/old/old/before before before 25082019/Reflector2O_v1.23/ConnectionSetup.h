...
const int Local_Server_Number = 2; //This will remain 2 in my convention. Never changed
...
public:
  static void connectionSetup() {        
    ...
    uint8_t mac[6] {0x2C, 0x3A, 0xE8, 0x40,0x31, 0xBC}; //Actually, this is the meant MAC 2C:3A:E8:40:31:BA. 
