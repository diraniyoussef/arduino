...
private:   
  ...
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { dummy_buff, "6:\0", "S4:\0", "TrekStor_Tab:\0" }; /*By convention, it's just 1 reflected panel that our panel is linked to, 
