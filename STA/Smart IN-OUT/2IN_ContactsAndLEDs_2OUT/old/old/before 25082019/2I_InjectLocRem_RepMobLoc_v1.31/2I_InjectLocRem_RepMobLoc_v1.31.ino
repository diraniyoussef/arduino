...
InformLocal inform_local; /*PLEASE NOTE THAT IF YOU WERE TO COMMENT THIS, then you must make some changes in Setup.h, like 
probably setting obeying_IPs.other_IPs_gotten to True or probably commenting and changing this line of code 
"if( !( obeying_IPs.other_IPs_gotten && network_conf_gotten ) ) {"
there. Also, follow the EEPROM although I believe it won't differ.*/
      ...
      */
      ...
      //    PCF1.checkManualUpdate();    //comment for PCF exclusion
          ...
          if( toggle_connect_failure_notifier_pin ) {
            Serial.println("Toggling notifier pin");
