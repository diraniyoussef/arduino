...
const char* mod_id_buff = "7:\0";

class RemoteServerMessageOp {
private:   
  static constexpr char* dummy_buff = "dummy:\0";
  static const int Reflected_Panels_Number = 5; //Don't forget to add "dummy" in the intermediate server.
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { dummy_buff, "6:\0", "S4:\0", "TrekStor_Tab:\0", "S7_Edge:\0" }; /*By 
