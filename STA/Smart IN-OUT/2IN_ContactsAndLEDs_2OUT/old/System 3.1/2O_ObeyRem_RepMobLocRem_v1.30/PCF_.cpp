 ...
 */
void PCF_::begin( uint8_t address ) {
  begin(address, SDA_PIN, SCL_PIN);
}
void PCF_::begin( uint8_t address, uint8_t sda, uint8_t scl ) {
	m_address = address;
 ...
 */
bool PCF_::setBit(uint8_t bit, bool value) {
...
bool PCF_::setByte(uint8_t value) { 
