...
const char* mod_id_buff = "2:\0";

class RemoteServerMessageOp {
private:   
  static constexpr char* dummy_buff = "dummy:\0";
  static const int Reflected_Panels_Number = 1; //Don't forget to add "dummy" in the intermediate server.
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { dummy_buff };
/*
  const char* reflected_i_Id_buff[ Reflected_Panels_Number ] = { dummy_buff, "S4:\0", "TrekStor_Tab:\0", "usr1:\0" }; /*By convention, it's just 1 reflected panel that our panel is linked to, 
